...
/*     */     {
/*  39 */       files = null;
/*  40 */       javax.swing.JOptionPane.showMessageDialog(null, "You need to select atleast two files\n\nPlease try again!\n\nCheckAgainst will now exit", "Error", 0);
/*  41 */       System.exit(0);
/*     */     }
/*     */     else
/*     */     {
...
/*     */         
/*     */ 
/*  68 */         javax.swing.JOptionPane.showMessageDialog(null, "The first file was not found\n\nEnsure that the first file exists\n\nCheckAgainst will now exit", "Error", 0);
/*     */ 
/*     */       }
/*     */       catch (java.io.IOException e)
/*     */       {
/*  73 */         javax.swing.JOptionPane.showMessageDialog(null, "An IOException occured with the first file\n\nCheckAgainst will now exit", "Error", 0);
/*     */       }
/*     */       
/*     */       try
/*     */       {
...
/*  81 */         PrintWriter outFile = new PrintWriter(bw);
...
/*     */                 else
/*     */                 {
/* 108 */                   outFile.println(line + " -----> FOUND");
/*     */                 }
/*     */               }
/*     */             }
...
/*     */           {
/*     */ 
/* 118 */             javax.swing.JOptionPane.showMessageDialog(null, "The other file was not found\n\nEnsure that the other files exist\n\nCheckAgainst will now exit", "Error", 0);
/*     */ 
/*     */ 
/*     */           }
/*     */           catch (java.io.IOException e)
/*     */           {
/*     */ 
/* 125 */             javax.swing.JOptionPane.showMessageDialog(null, "An IOException occured with the other file\n\nCheckAgainst will now exit", "Error", 0);
/*     */           }
/*     */         }
/*     */         
...
/*     */       catch (java.io.FileNotFoundException e)
/*     */       {
/* 133 */         javax.swing.JOptionPane.showMessageDialog(null, "A FileNotFoundException occured with the file 'checked.txt'", "Error", 0);
/*     */ 
/*     */       }
/*     */       catch (java.io.IOException e)
/*     */       {
/* 138 */         javax.swing.JOptionPane.showMessageDialog(null, "An IOException occured with the file 'checked.txt'", "Error", 0);
/*     */       }
/*     */     }
/*     */   }
/*     */ }
