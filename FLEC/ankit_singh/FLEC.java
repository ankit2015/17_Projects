...
/*      */       {
/*      */ 
/*  542 */         java.net.URL hp = new java.net.URL(loc);
/*  543 */         java.net.URLConnection hpCon = hp.openConnection();
/*  544 */         int len = hpCon.getContentLength();
/*      */         
/*  546 */         if (len != 0)
/*      */         {
/*      */ 
/*      */ 
/*  550 */           java.io.InputStream input = hpCon.getInputStream();
/*  551 */           java.io.InputStreamReader in = new java.io.InputStreamReader(input);
/*  552 */           BufferedReader br = new BufferedReader(in);
/*  553 */           boolean alive = false;
/*      */           
/*  555 */           java.util.regex.Matcher mat = null;
/*      */           String s1;
/*  557 */           while ((s1 = br.readLine()) != null)
/*      */           {
/*      */ 
/*  560 */             mat = this.pat3[m].matcher(s1);
/*  561 */             if (mat.find())
/*      */             {
/*      */ 
/*  564 */               if (this.unique.contains(loc))
/*      */               {
/*  566 */                 this.outFile.println(loc + " ====>REDUNDANT");
/*  567 */                 alive = true;
/*      */ 
/*      */               }
/*      */               else
/*      */               {
/*      */ 
/*  573 */                 this.outFile.println(loc);
/*  574 */                 this.unique.add(loc);
/*  575 */                 alive = true;
/*      */               }
/*      */             }
/*      */           }
...
/*  581 */           if (!alive)
/*      */           {
/*  583 */             this.outFile.println(loc + " ---->DEAD");
/*      */           }
/*      */           
/*  586 */           br.close();
/*      */         }
...
/*      */       catch (java.net.MalformedURLException e)
/*      */       {
/*  592 */         javax.swing.JOptionPane.showMessageDialog(this, "This filehost URL is invalid:\n" + loc, "Error", 0);
/*      */       }
/*      */       catch (java.io.IOException e)
/*      */       {
/*  596 */         this.retry -= 1;
...
/*  598 */         if (this.retry == 0)
/*      */         {
/*  600 */           this.outFile.println(loc + " *****NOT-CHECKED");
/*  601 */           this.retry = 5;
/*      */         }
/*      */         else
/*      */         {
...
/*  619 */     try { java.net.URL hp = new java.net.URL(loc);
/*  620 */       java.net.URLConnection hpCon = hp.openConnection();
/*      */       
/*      */ 
/*      */ 
/*  624 */       StringBuilder s3 = new StringBuilder("");
/*      */       
/*  626 */       java.io.InputStream input = hpCon.getInputStream();
/*  627 */       java.io.InputStreamReader in = new java.io.InputStreamReader(input);
/*  628 */       BufferedReader br = new BufferedReader(in);
/*      */       
/*  630 */       java.util.regex.Matcher mat = null;
/*      */       String s1;
/*  632 */       while ((s1 = br.readLine()) != null)
/*      */       {
/*  634 */         mat = this.pat.matcher(s1);
/*  635 */         if (mat.find())
/*      */         {
/*  637 */           for (int i = mat.end(); i < s1.length(); i++)
/*      */           {
/*  639 */             char c = s1.charAt(i);
/*  640 */             if (c == '<') {
/*      */               break;
/*      */             }
/*      */             
...
/*      */       }
/*      */       
/*  651 */       String s = s3.toString().trim().replace('*', '-');
/*  652 */       s = s.replace('|', '-');
/*  653 */       s = s.replace('\'', '-');
/*  654 */       s = s.replace(':', '-');
/*  655 */       s = s.replace('"', '-');
...
/*  657 */       s = s.replace('>', '-');
/*  658 */       s = s.replace('?', '-');
/*  659 */       return s.replace('/', '-');
/*      */ 
/*      */     }
/*      */     catch (java.net.MalformedURLException e)
/*      */     {
/*  664 */       javax.swing.JOptionPane.showMessageDialog(this, "The 'First Page' URL is invalid", "Error", 0);
/*      */     }
/*      */     catch (java.io.IOException e)
/*      */     {
/*  668 */       javax.swing.JOptionPane.showMessageDialog(this, "Unable to access 'First Page' due to:\n1. No Internet access or\n2. 'First Page' temporarily unavailable or\n3. 'First Page' does not exists", "Error", 0);
/*      */       
/*  670 */       return "FLEC";
/*      */     }
/*  672 */     return "FLEC";
...
/*      */   
/*  683 */   private void initComponents() { this.jLabel1 = new javax.swing.JLabel();
/*  684 */     this.jTextField1 = new JTextField();
/*  685 */     this.jLabel2 = new javax.swing.JLabel();
/*  686 */     this.jTextField2 = new JTextField();
/*  687 */     this.jLabel3 = new javax.swing.JLabel();
/*  688 */     this.jTextField3 = new JTextField();
/*  689 */     this.jLabel4 = new javax.swing.JLabel();
/*  690 */     this.jTextField4 = new JTextField();
/*  691 */     this.jButton1 = new javax.swing.JButton();
/*  692 */     this.jButton2 = new javax.swing.JButton();
/*  693 */     this.jButton3 = new javax.swing.JButton();
/*  694 */     this.jSeparator1 = new javax.swing.JSeparator();
/*  695 */     this.jCheckBox1 = new JCheckBox();
/*  696 */     this.jCheckBox2 = new JCheckBox();
/*  697 */     this.jCheckBox3 = new JCheckBox();
/*  698 */     this.jCheckBox4 = new JCheckBox();
/*  699 */     this.jCheckBox5 = new JCheckBox();
/*  700 */     this.jCheckBox6 = new JCheckBox();
/*  701 */     this.jCheckBox7 = new JCheckBox();
/*  702 */     this.jCheckBox8 = new JCheckBox();
/*  703 */     this.jCheckBox9 = new JCheckBox();
/*  704 */     this.jCheckBox10 = new JCheckBox();
/*  705 */     this.jCheckBox11 = new JCheckBox();
/*  706 */     this.jCheckBox12 = new JCheckBox();
/*  707 */     this.jButton4 = new javax.swing.JButton();
/*  708 */     this.jCheckBox13 = new JCheckBox();
/*  709 */     this.jCheckBox14 = new JCheckBox();
/*  710 */     this.jCheckBox15 = new JCheckBox();
/*  711 */     this.jCheckBox16 = new JCheckBox();
/*  712 */     this.jCheckBox17 = new JCheckBox();
/*  713 */     this.jCheckBox18 = new JCheckBox();
/*  714 */     this.jCheckBox19 = new JCheckBox();
/*  715 */     this.jCheckBox20 = new JCheckBox();
/*  716 */     this.jCheckBox21 = new JCheckBox();
/*  717 */     this.jCheckBox22 = new JCheckBox();
/*  718 */     this.jCheckBox23 = new JCheckBox();
/*  719 */     this.jCheckBox24 = new JCheckBox();
/*  720 */     this.jCheckBox25 = new JCheckBox();
/*  721 */     this.jCheckBox26 = new JCheckBox();
/*  722 */     this.jCheckBox27 = new JCheckBox();
/*  723 */     this.jCheckBox28 = new JCheckBox();
/*  724 */     this.jCheckBox29 = new JCheckBox();
/*  725 */     this.jCheckBox30 = new JCheckBox();
/*  726 */     this.jCheckBox31 = new JCheckBox();
/*  727 */     this.jCheckBox32 = new JCheckBox();
/*  728 */     this.jCheckBox33 = new JCheckBox();
/*  729 */     this.jCheckBox34 = new JCheckBox();
/*  730 */     this.jCheckBox35 = new JCheckBox();
/*  731 */     this.jCheckBox36 = new JCheckBox();
/*  732 */     this.jCheckBox37 = new JCheckBox();
/*  733 */     this.jCheckBox38 = new JCheckBox();
/*  734 */     this.jCheckBox39 = new JCheckBox();
/*  735 */     this.jCheckBox40 = new JCheckBox();
/*      */     
/*  737 */     setDefaultCloseOperation(3);
/*  738 */     setTitle("FLEC (Forum Link Extractor & Checker)");
/*      */     
/*  740 */     this.jLabel1.setText("First Page    :");
/*      */     
/*  742 */     this.jLabel2.setText("Second Page:");
/*      */     
/*  744 */     this.jLabel3.setText("Third Page   :");
/*      */     
/*  746 */     this.jLabel4.setText("Last Page    :");
/*      */     
/*  748 */     this.jButton1.setText("Extract");
/*  749 */     this.jButton1.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  751 */         FLEC.this.jButton1ActionPerformed(evt);
/*      */       }
/*      */       
/*  754 */     });
/*  755 */     this.jButton2.setText("Exit");
/*  756 */     this.jButton2.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  758 */         FLEC.this.jButton2ActionPerformed(evt);
/*      */       }
/*      */       
/*  761 */     });
/*  762 */     this.jButton3.setText("Reset");
/*  763 */     this.jButton3.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  765 */         FLEC.this.jButton3ActionPerformed(evt);
/*      */       }
/*      */       
/*  768 */     });
/*  769 */     this.jCheckBox1.setText("jCheckBox1");
/*  770 */     this.jCheckBox1.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  772 */         FLEC.this.jCheckBox1ActionPerformed(evt);
/*      */       }
/*      */       
/*  775 */     });
/*  776 */     this.jCheckBox2.setText("jCheckBox2");
/*  777 */     this.jCheckBox2.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  779 */         FLEC.this.jCheckBox2ActionPerformed(evt);
/*      */       }
/*      */       
/*  782 */     });
/*  783 */     this.jCheckBox3.setText("jCheckBox3");
/*  784 */     this.jCheckBox3.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  786 */         FLEC.this.jCheckBox3ActionPerformed(evt);
/*      */       }
/*      */       
/*  789 */     });
/*  790 */     this.jCheckBox4.setText("jCheckBox4");
/*  791 */     this.jCheckBox4.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  793 */         FLEC.this.jCheckBox4ActionPerformed(evt);
/*      */       }
/*      */       
/*  796 */     });
/*  797 */     this.jCheckBox5.setText("jCheckBox5");
/*  798 */     this.jCheckBox5.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  800 */         FLEC.this.jCheckBox5ActionPerformed(evt);
/*      */       }
/*      */       
/*  803 */     });
/*  804 */     this.jCheckBox6.setText("jCheckBox6");
/*  805 */     this.jCheckBox6.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  807 */         FLEC.this.jCheckBox6ActionPerformed(evt);
/*      */       }
/*      */       
/*  810 */     });
/*  811 */     this.jCheckBox7.setText("jCheckBox7");
/*  812 */     this.jCheckBox7.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  814 */         FLEC.this.jCheckBox7ActionPerformed(evt);
/*      */       }
/*      */       
/*  817 */     });
/*  818 */     this.jCheckBox8.setText("jCheckBox8");
/*  819 */     this.jCheckBox8.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  821 */         FLEC.this.jCheckBox8ActionPerformed(evt);
/*      */       }
/*      */       
/*  824 */     });
/*  825 */     this.jCheckBox9.setText("jCheckBox9");
/*  826 */     this.jCheckBox9.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  828 */         FLEC.this.jCheckBox9ActionPerformed(evt);
/*      */       }
/*      */       
/*  831 */     });
/*  832 */     this.jCheckBox10.setText("jCheckBox10");
/*  833 */     this.jCheckBox10.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  835 */         FLEC.this.jCheckBox10ActionPerformed(evt);
/*      */       }
/*      */       
/*  838 */     });
/*  839 */     this.jCheckBox11.setText("jCheckBox11");
/*  840 */     this.jCheckBox11.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  842 */         FLEC.this.jCheckBox11ActionPerformed(evt);
/*      */       }
/*      */       
/*  845 */     });
/*  846 */     this.jCheckBox12.setText("jCheckBox12");
/*  847 */     this.jCheckBox12.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  849 */         FLEC.this.jCheckBox12ActionPerformed(evt);
/*      */       }
/*      */       
/*  852 */     });
/*  853 */     this.jButton4.setText("About");
/*  854 */     this.jButton4.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  856 */         FLEC.this.jButton4ActionPerformed(evt);
/*      */       }
/*      */       
/*  859 */     });
/*  860 */     this.jCheckBox13.setText("jCheckBox13");
/*  861 */     this.jCheckBox13.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  863 */         FLEC.this.jCheckBox13ActionPerformed(evt);
/*      */       }
/*      */       
/*  866 */     });
/*  867 */     this.jCheckBox14.setText("jCheckBox14");
/*  868 */     this.jCheckBox14.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  870 */         FLEC.this.jCheckBox14ActionPerformed(evt);
/*      */       }
/*      */       
/*  873 */     });
/*  874 */     this.jCheckBox15.setText("jCheckBox15");
/*  875 */     this.jCheckBox15.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  877 */         FLEC.this.jCheckBox15ActionPerformed(evt);
/*      */       }
/*      */       
/*  880 */     });
/*  881 */     this.jCheckBox16.setText("jCheckBox16");
/*  882 */     this.jCheckBox16.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  884 */         FLEC.this.jCheckBox16ActionPerformed(evt);
/*      */       }
/*      */       
/*  887 */     });
/*  888 */     this.jCheckBox17.setText("jCheckBox17");
/*  889 */     this.jCheckBox17.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  891 */         FLEC.this.jCheckBox17ActionPerformed(evt);
/*      */       }
/*      */       
/*  894 */     });
/*  895 */     this.jCheckBox18.setText("jCheckBox18");
/*  896 */     this.jCheckBox18.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  898 */         FLEC.this.jCheckBox18ActionPerformed(evt);
/*      */       }
/*      */       
/*  901 */     });
/*  902 */     this.jCheckBox19.setText("jCheckBox19");
/*  903 */     this.jCheckBox19.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  905 */         FLEC.this.jCheckBox19ActionPerformed(evt);
/*      */       }
/*      */       
/*  908 */     });
/*  909 */     this.jCheckBox20.setText("jCheckBox20");
/*  910 */     this.jCheckBox20.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  912 */         FLEC.this.jCheckBox20ActionPerformed(evt);
/*      */       }
/*      */       
/*  915 */     });
/*  916 */     this.jCheckBox21.setText("jCheckBox21");
/*  917 */     this.jCheckBox21.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  919 */         FLEC.this.jCheckBox21ActionPerformed(evt);
/*      */       }
/*      */       
/*  922 */     });
/*  923 */     this.jCheckBox22.setText("jCheckBox22");
/*  924 */     this.jCheckBox22.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  926 */         FLEC.this.jCheckBox22ActionPerformed(evt);
/*      */       }
/*      */       
/*  929 */     });
/*  930 */     this.jCheckBox23.setText("jCheckBox23");
/*  931 */     this.jCheckBox23.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  933 */         FLEC.this.jCheckBox23ActionPerformed(evt);
/*      */       }
/*      */       
/*  936 */     });
/*  937 */     this.jCheckBox24.setText("jCheckBox24");
/*  938 */     this.jCheckBox24.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  940 */         FLEC.this.jCheckBox24ActionPerformed(evt);
/*      */       }
/*      */       
/*  943 */     });
/*  944 */     this.jCheckBox25.setText("jCheckBox25");
/*  945 */     this.jCheckBox25.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  947 */         FLEC.this.jCheckBox25ActionPerformed(evt);
/*      */       }
/*      */       
/*  950 */     });
/*  951 */     this.jCheckBox26.setText("jCheckBox26");
/*  952 */     this.jCheckBox26.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  954 */         FLEC.this.jCheckBox26ActionPerformed(evt);
/*      */       }
/*      */       
/*  957 */     });
/*  958 */     this.jCheckBox27.setText("jCheckBox27");
/*  959 */     this.jCheckBox27.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  961 */         FLEC.this.jCheckBox27ActionPerformed(evt);
/*      */       }
/*      */       
/*  964 */     });
/*  965 */     this.jCheckBox28.setText("jCheckBox28");
/*  966 */     this.jCheckBox28.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  968 */         FLEC.this.jCheckBox28ActionPerformed(evt);
/*      */       }
/*      */       
/*  971 */     });
/*  972 */     this.jCheckBox29.setText("jCheckBox29");
/*  973 */     this.jCheckBox29.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  975 */         FLEC.this.jCheckBox29ActionPerformed(evt);
/*      */       }
/*      */       
/*  978 */     });
/*  979 */     this.jCheckBox30.setText("jCheckBox30");
/*  980 */     this.jCheckBox30.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  982 */         FLEC.this.jCheckBox30ActionPerformed(evt);
/*      */       }
/*      */       
/*  985 */     });
/*  986 */     this.jCheckBox31.setText("jCheckBox31");
/*  987 */     this.jCheckBox31.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  989 */         FLEC.this.jCheckBox31ActionPerformed(evt);
/*      */       }
/*      */       
/*  992 */     });
/*  993 */     this.jCheckBox32.setText("jCheckBox32");
/*  994 */     this.jCheckBox32.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/*  996 */         FLEC.this.jCheckBox32ActionPerformed(evt);
/*      */       }
/*      */       
/*  999 */     });
/* 1000 */     this.jCheckBox33.setText("jCheckBox33");
/* 1001 */     this.jCheckBox33.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/* 1003 */         FLEC.this.jCheckBox33ActionPerformed(evt);
/*      */       }
/*      */       
/* 1006 */     });
/* 1007 */     this.jCheckBox34.setText("jCheckBox34");
/* 1008 */     this.jCheckBox34.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/* 1010 */         FLEC.this.jCheckBox34ActionPerformed(evt);
/*      */       }
/*      */       
/* 1013 */     });
/* 1014 */     this.jCheckBox35.setText("jCheckBox35");
/* 1015 */     this.jCheckBox35.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/* 1017 */         FLEC.this.jCheckBox35ActionPerformed(evt);
/*      */       }
/*      */       
/* 1020 */     });
/* 1021 */     this.jCheckBox36.setText("jCheckBox36");
/* 1022 */     this.jCheckBox36.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/* 1024 */         FLEC.this.jCheckBox36ActionPerformed(evt);
/*      */       }
/*      */       
/* 1027 */     });
/* 1028 */     this.jCheckBox37.setText("jCheckBox37");
/* 1029 */     this.jCheckBox37.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/* 1031 */         FLEC.this.jCheckBox37ActionPerformed(evt);
/*      */       }
/*      */       
/* 1034 */     });
/* 1035 */     this.jCheckBox38.setText("jCheckBox38");
/* 1036 */     this.jCheckBox38.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/* 1038 */         FLEC.this.jCheckBox38ActionPerformed(evt);
/*      */       }
/*      */       
/* 1041 */     });
/* 1042 */     this.jCheckBox39.setText("jCheckBox39");
/* 1043 */     this.jCheckBox39.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/* 1045 */         FLEC.this.jCheckBox39ActionPerformed(evt);
/*      */       }
/*      */       
/* 1048 */     });
/* 1049 */     this.jCheckBox40.setText("jCheckBox40");
/* 1050 */     this.jCheckBox40.addActionListener(new ActionListener() {
/*      */       public void actionPerformed(ActionEvent evt) {
/* 1052 */         FLEC.this.jCheckBox40ActionPerformed(evt);
/*      */       }
/*      */       
/* 1055 */     });
/* 1056 */     GroupLayout layout = new GroupLayout(getContentPane());
/* 1057 */     getContentPane().setLayout(layout);
/* 1058 */     layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jCheckBox25).addComponent(this.jCheckBox9).addComponent(this.jCheckBox17).addComponent(this.jCheckBox1).addComponent(this.jCheckBox33)).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jCheckBox26).addComponent(this.jCheckBox10).addComponent(this.jCheckBox18).addComponent(this.jCheckBox2).addComponent(this.jCheckBox34)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jCheckBox19).addComponent(this.jCheckBox27).addComponent(this.jCheckBox11).addComponent(this.jCheckBox3).addComponent(this.jCheckBox35)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jCheckBox20).addComponent(this.jCheckBox28).addComponent(this.jCheckBox12).addComponent(this.jCheckBox4).addComponent(this.jCheckBox36)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jCheckBox21).addComponent(this.jCheckBox29).addComponent(this.jCheckBox13).addComponent(this.jCheckBox5).addComponent(this.jCheckBox37)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jCheckBox22).addComponent(this.jCheckBox14).addComponent(this.jCheckBox6).addComponent(this.jCheckBox30).addComponent(this.jCheckBox38)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jCheckBox23).addComponent(this.jCheckBox15).addComponent(this.jCheckBox7).addComponent(this.jCheckBox31).addComponent(this.jCheckBox39)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jCheckBox24).addComponent(this.jCheckBox16).addComponent(this.jCheckBox8).addComponent(this.jCheckBox32).addComponent(this.jCheckBox40))).addGroup(layout.createSequentialGroup().addGap(10, 10, 10).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jLabel2).addComponent(this.jLabel1).addComponent(this.jLabel3).addComponent(this.jLabel4)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addGap(16, 16, 16).addComponent(this.jButton1).addGap(18, 18, 18).addComponent(this.jButton2).addGap(18, 18, 18).addComponent(this.jButton3).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 301, 32767).addComponent(this.jButton4).addGap(13, 13, 13)).addComponent(this.jTextField3, -1, 614, 32767).addComponent(this.jTextField2, -1, 614, 32767).addComponent(this.jTextField4, -1, 614, 32767).addComponent(this.jTextField1, -1, 614, 32767)).addGap(10, 10, 10)).addGroup(layout.createSequentialGroup().addContainerGap().addComponent(this.jSeparator1, -1, 684, 32767).addContainerGap()));
/*      */     
/*      */ 
/*      */ 
/*      */ 
...
/*      */     try
/*      */     {
/* 1420 */       for (javax.swing.UIManager.LookAndFeelInfo info : ) {
/* 1421 */         if ("Windows".equals(info.getName())) {
/* 1422 */           javax.swing.UIManager.setLookAndFeel(info.getClassName());
/* 1423 */           break;
/*      */         }
/*      */       }
/*      */     } catch (Exception ex) {
/* 1427 */       javax.swing.JOptionPane.showMessageDialog(null, "L&F error", "Internal error", 0);
/*      */     }
/*      */     
/*      */ 
/*      */ 
/* 1432 */     java.awt.EventQueue.invokeLater(new Runnable()
/*      */     {
/*      */       public void run()
/*      */       {
/* 1436 */         new FLEC().setVisible(true);
/*      */       }
/*      */     });
/*      */   }
/*      */   
