...
public class CheckAgainst
{
  public static void main(String[] args)
  {
    ...
    {
      files = null;
      JOptionPane.showMessageDialog(null, "You need to select atleast two files\n\nPlease try again!\n\nCheckAgainst will now exit", "Error", 0);
      System.exit(0);
    }
    else
    {
      ...
      catch (java.io.FileNotFoundException e)
      {
        ...
        JOptionPane.showMessageDialog(null, "The first file was not found\n\nEnsure that the first file exists\n\nCheckAgainst will now exit", "Error", 0);

      }
      catch (java.io.IOException e)
      {
        JOptionPane.showMessageDialog(null, "An IOException occured with the first file\n\nCheckAgainst will now exit", "Error", 0);
      }
      ...
      try
      {
        ...
        for (int i = 1; i < files.length; i++)
        {
          ...
          catch (java.io.FileNotFoundException e)
          {
            ...
            JOptionPane.showMessageDialog(null, "The other file was not found\n\nEnsure that the other files exist\n\nCheckAgainst will now exit", "Error", 0);
          ...
          catch (java.io.IOException e)
          {
            ...
            JOptionPane.showMessageDialog(null, "An IOException occured with the other file\n\nCheckAgainst will now exit", "Error", 0);
          }
        }
      ...
      {
        JOptionPane.showMessageDialog(null, "A FileNotFoundException occured with the file 'checked.txt'", "Error", 0);

      }
      catch (java.io.IOException e)
      {
        JOptionPane.showMessageDialog(null, "An IOException occured with the file 'checked.txt'", "Error", 0);
      }
    }
  }
}
